...
def perform_sieve_analysis():
    ...
    bin_edges = np.logspace(np.log10(min_diameter), np.log10(max_diameter), num=21)  # 20 intervals
...
def main():
    ...
    bg_image = Image.open(r"C:\Users\rauna\Desktop\fragment_analysis.jpeg")
